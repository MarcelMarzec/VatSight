...
* ❌ You cannot use this code to create or distribute a competing app (e.g. on the App Store)
...
* Improve the **user experience**, not just code structure
* Solve real problems for VATSIM users
