# VatSight
VatSight in an in development IOS app for exloring the live traffic on the VATSIM network. Track pilots, check for ATC, and visualize airspace in real time.
